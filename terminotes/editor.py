"""Utilities and helpers for capturing and parsing note editor content."""
...
def render_document(title: str, body: str, metadata: dict[str, Any]) -> str:
    """Render note content with YAML front matter for the editor."""
...
def parse_document(raw: str) -> ParsedEditorNote:
    """Parse editor content into front matter and body components."""
